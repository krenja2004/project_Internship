// JavaScript framework to build Responsive Sidebar, Header, Mobile Drawer, Bottom Nav, Dark Mode, and Live Balance for Client/User Workspace

document.addEventListener('DOMContentLoaded', () => {
    // 0. Kiểm tra quyền Client / Khách Hàng
    let user = null;
    try {
    ...
    if (user.role === 'freelancer') {
        alert('Tài khoản của bạn là Freelancer. Đang chuyển hướng sang Freelancer Hub...');
    ...
    <aside class="w-64 bg-white dark:bg-gray-800 shadow-xl h-full flex flex-col transition-colors border-r border-gray-200 dark:border-gray-700 hidden md:flex z-40 shrink-0">
        ...
        <nav class="flex-1 p-4 space-y-1.5 overflow-y-auto">
            ...
            <a href="post-job.html" class="nav-item flex items-center space-x-3 px-4 py-3 rounded-xl text-gray-600 dark:text-gray-300 hover:bg-indigo-50 dark:hover:bg-gray-700 hover:text-indigo-600 dark:hover:text-indigo-400 font-semibold transition-colors">
                <i class="fas fa-plus-circle w-5 text-blue-500"></i> <span>Đăng Dự Án</span>
            </a>
            <a href="my-requests.html" class="nav-item flex items-center space-x-3 px-4 py-3 rounded-xl text-gray-600 dark:text-gray-300 hover:bg-indigo-50 dark:hover:bg-gray-700 hover:text-indigo-600 dark:hover:text-indigo-400 font-semibold transition-colors">
                <i class="fas fa-tasks w-5 text-purple-500"></i> <span>Dự án đang mở</span>
            </a>
            <a href="review-work.html" class="nav-item flex items-center space-x-3 px-4 py-3 rounded-xl text-gray-600 dark:text-gray-300 hover:bg-indigo-50 dark:hover:bg-gray-700 hover:text-indigo-600 dark:hover:text-indigo-400 font-semibold transition-colors">
                <i class="fas fa-check-double w-5 text-emerald-500"></i> <span>Quản lý Tiến độ</span>
            </a>
            <a href="my-reviews.html" class="nav-item flex items-center space-x-3 px-4 py-3 rounded-xl text-gray-600 dark:text-gray-300 hover:bg-indigo-50 dark:hover:bg-gray-700 hover:text-indigo-600 dark:hover:text-indigo-400 font-semibold transition-colors">
                <i class="fas fa-star w-5 text-amber-400"></i> <span>Đánh giá của tôi</span>
            </a>
            <a href="wallet.html" class="nav-item flex items-center space-x-3 px-4 py-3 rounded-xl text-gray-600 dark:text-gray-300 hover:bg-indigo-50 dark:hover:bg-gray-700 hover:text-indigo-600 dark:hover:text-indigo-400 font-semibold transition-colors">
                <i class="fas fa-wallet w-5 text-amber-500"></i> <span>Quản lý Ví</span>
            </a>
            ...
            <a href="profile.html" class="nav-item flex items-center space-x-3 px-4 py-3 rounded-xl text-gray-600 dark:text-gray-300 hover:bg-indigo-50 dark:hover:bg-gray-700 hover:text-indigo-600 dark:hover:text-indigo-400 font-semibold transition-colors">
                <i class="fas fa-user-circle w-5 text-rose-500"></i> <span>Hồ sơ cá nhân</span>
            </a>
        </nav>
    ...
    <div id="mobileDrawerOverlay" class="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 hidden transition-opacity duration-300 md:hidden">
        <div id="mobileDrawerContent" class="fixed inset-y-0 left-0 w-72 max-w-[85vw] bg-white dark:bg-gray-800 shadow-2xl flex flex-col transform -translate-x-full transition-transform duration-300 ease-in-out border-r border-gray-200 dark:border-gray-700">
            ...
            <nav class="flex-1 p-4 space-y-1.5 overflow-y-auto">
                ...
                <a href="post-job.html" class="drawer-item flex items-center space-x-3 px-4 py-3 rounded-xl text-gray-700 dark:text-gray-300 hover:bg-indigo-50 dark:hover:bg-gray-700 font-semibold">
                    <i class="fas fa-plus-circle w-5 text-blue-500"></i> <span>Đăng Dự Án</span>
                </a>
                <a href="my-requests.html" class="drawer-item flex items-center space-x-3 px-4 py-3 rounded-xl text-gray-700 dark:text-gray-300 hover:bg-indigo-50 dark:hover:bg-gray-700 font-semibold">
                    <i class="fas fa-tasks w-5 text-purple-500"></i> <span>Dự án đang mở</span>
                </a>
                <a href="review-work.html" class="drawer-item flex items-center space-x-3 px-4 py-3 rounded-xl text-gray-700 dark:text-gray-300 hover:bg-indigo-50 dark:hover:bg-gray-700 font-semibold">
                    <i class="fas fa-check-double w-5 text-emerald-500"></i> <span>Quản lý Tiến độ</span>
                </a>
                <a href="my-reviews.html" class="drawer-item flex items-center space-x-3 px-4 py-3 rounded-xl text-gray-700 dark:text-gray-300 hover:bg-indigo-50 dark:hover:bg-gray-700 font-semibold">
                    <i class="fas fa-star w-5 text-amber-400"></i> <span>Đánh giá của tôi</span>
                </a>
    ...
    `<header class="h-14 sm:h-16 md:h-20 bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700 flex items-center justify-between px-3 sm:px-4 md:px-6 transition-colors z-30 relative shrink-0">
        <div class="flex items-center space-x-2 sm:space-x-3 shrink-0">
            ...
            <h1 class="text-sm sm:text-base md:text-xl font-black text-gray-800 dark:text-white truncate max-w-[120px] sm:max-w-[200px] md:max-w-none" id="pageTitle">Client Portal</h1>
        </div>
        
        <div class="flex items-center space-x-2 sm:space-x-3 md:space-x-4 shrink-0">
            <!-- Số dư Token -->
            <a href="wallet.html" class="flex items-center space-x-1.5 bg-emerald-50 dark:bg-emerald-950/50 border border-emerald-200 dark:border-emerald-800/80 px-2.5 py-1.5 sm:px-3.5 sm:py-2 rounded-full shadow-sm hover:bg-emerald-100 dark:hover:bg-emerald-900/40 transition shrink-0" title="Quản lý Ví & Nạp Token">
    ...
    `<nav class="fixed bottom-0 left-0 right-0 z-40 bg-white/95 dark:bg-gray-800/95 backdrop-blur-md border-t border-gray-200 dark:border-gray-700 md:hidden flex justify-around items-center py-1.5 px-2 shadow-lg">
        ...
        <a href="post-job.html" class="bottom-nav-item flex flex-col items-center justify-center -mt-3.5 bg-indigo-600 text-white w-12 h-12 rounded-full shadow-lg hover:bg-indigo-700 transition">
    ...
    const pageAliases = {
        'post job.html': 'post-job.html',
        'post_job.html': 'post-job.html',
        'my requests.html': 'my-requests.html',
        'my_requests.html': 'my-requests.html',
        'direct chat.html': 'direct-chat.html',
        'direct_chat.html': 'direct-chat.html',
        'escrow-test.html': 'review-work.html'
    };
    ...
    document.querySelectorAll('.nav-item').forEach(link => {
        ...
        if (href === currentPage || href === decodedPage || href === rawPage) {
            ...
            if (titleEl) {
                titleEl.innerText = link.querySelector('span')?.innerText || 'Client Hub';
            }
        }
    });
