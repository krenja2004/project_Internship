-- ===================================================
-- HT_WORK: CORE BANKING - DEPOSIT (NẠP TIỀN)
-- ===================================================

-- 1. Hàm Duyệt Nạp Tiền (Bảo vệ ACID + Chống Race Condition)
...
BEGIN
    ...
    IF v_wallet IS NULL THEN
        INSERT INTO public.wallets (user_id, balance) VALUES (v_request.user_id, 0);
    ELSE
        -- Khóa ROW ví
    ...
    -- Quy ước: Nạp tiền thì sender_id = NULL (hệ thống), receiver_id = user
